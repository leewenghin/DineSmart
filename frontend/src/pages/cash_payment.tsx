  ...
  return (
    <>
      <div className="full-content flex flex-col container">
        <div className="md:flex justify-center block mx-auto">
          <div className="lg:!px-20 px-3 py-4 bg-white  md:w-3/5 mx-auto">
            ...
            <div className=" block justify-between gap-4 border-t-2 mx-auto  ">
